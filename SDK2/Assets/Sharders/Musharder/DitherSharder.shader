...
Shader "Mushader/Dither"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutputForwardBase2 vert (VertexInput v) {
                VertexOutputForwardBase i = vertForwardBase(v);
            ...
            half4 frag (VertexOutputForwardBase2 i) : SV_Target {
                ...
                fixed4 c = fragForwardBaseInternal(o);
                ...
                c.a = clamp(c.a + 0.99*(ran-0.5)/float(MSAASampleCount), 0.0, 1.0);
                return c; 
            }
